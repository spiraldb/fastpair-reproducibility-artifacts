# `b300-splitncu` — split8read vs stride-16 on the SAME cell

NCU `--set full`, 8 captures, all CAPTURE-VERIFIED (see `SPLITNCU_CENSUS.txt`; each capture
...
**Do not confuse this with `b300-shdict-ncu`.** That set pairs `split8read` against `pdict`,
