# `h100-shdict` — staged-dictionary counterfactual
...
**Answer on this box: no.** Every staging variant loses to the shipped L1-served gather on
every column at every bit width where staging is possible at all, and above FastPair-12 it
stops being possible.

- Box: NVIDIA H100 80GB HBM3 (Nebius, eu-north1). Per-block shared-memory limit 227 KB.
